...
Tekijät: Ville Niemi ja Matias Aitolahti
Opiskelijanumerot: 050233597 ja H293115
Sähköpostit: ville.j.niemi@tuni.fi ja matias.aitolahti@tuni.fi
Tehtävä: GUI-projekti, Kehittynyt käyttöliittymä

(Koodi ja kommentointi on tehty englanniksi selkeyden vuoksi, mutta
käyttöliittymä itsessään on suomeksi, jotta ohjelma "tekee järkeä".)
